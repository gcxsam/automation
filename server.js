  ...
  try {
    ...
    const response = await openai.createChatCompletion({
      ...
      messages: [
        ...
        {
          role: "user",
          content:"Generate random less than 20 words tweet using the following description :@glocomx platform offers fractional ownership of high-value real estate through NFTs, using our utility tokens built on Ethereum. Our blockchain technology provides transparency, security, and efficiency while reducing investment barriers. We charge a transaction fee and have significant growth potential in the blockchain and NFT real estate market. Our GloComX Marketplace is governed by a hybrid DAO on Ethereum, allowing members to propose and vote on decisions using tokens as votes. The board approves proposals and can amend or dissolve the constitution by a two-thirds majority vote, with remaining assets given to a non-profit promoting fair trade and social responsibility.Note: Include relevant emojis where necessary and you should generate content whose word count should be less than 20 words."
        },
      ],
    });
